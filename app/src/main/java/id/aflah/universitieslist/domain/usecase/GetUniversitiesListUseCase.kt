...
class GetUniversitiesListUseCase @Inject constructor(
    private val repository: UniversityRepository
): UseCase<Flow<ResultState<List<University>>>, String>() {
    override fun build(params: String?): Flow<ResultState<List<University>>> = repository.getUniversitiesList(
        country = params.orEmpty()
    )
}